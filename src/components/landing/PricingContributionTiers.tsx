...
export function PricingContributionTiers() {
    return (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed font-body">
                        Choose how you want to support the ecosystem. Your contribution tier defines your giving identity, not a commercial transaction. All funds pool into targeted regions.
                    </p>
                </div>

                <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {/* Tier 1 */}
                    <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group">
                        ...
                        <h3 className="text-2xl font-bold text-cinematic-dark mb-2">Resource Provider</h3>
                        <div className="flex items-baseline gap-1 mb-6">
                            <span className="text-4xl font-bold text-cinematic-dark">$15</span>
                            <span className="text-gray-500 font-medium">/ month</span>
                        </div>
                        <ul className="space-y-4 mb-8 text-gray-600">
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-trust-blue" />
                                Supplies books and learning kits for an entire classroom.
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-trust-blue" />
                                Provides daily nutritional meals for 30 students.
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-trust-blue" />
                    ...
                    {/* Tier 2 */}
                    <div className="bg-cinematic-dark rounded-2xl p-8 border border-cinematic-dark shadow-xl relative transform md:-translate-y-4 transition-all duration-300 hover:-translate-y-6">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">Community Builder</h3>
                        ...
                        <ul className="space-y-4 mb-8 text-white/80">
                            <li className="flex items-start gap-3">
                                ...
                                Supports teacher salaries for an academic year.
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-impact-gold" />
                                Builds clean water systems and sanitation facilities.
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-impact-gold" />
                                Repairs critical school infrastructure.
                            </li>
                        </ul>
                        <Link
                            href="/programs"
                    ...
                    <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group">
                        ...
                        <h3 className="text-2xl font-bold text-cinematic-dark mb-2">Visionary Partner</h3>
                        <div className="flex items-baseline gap-1 mb-6">
                            <span className="text-4xl font-bold text-cinematic-dark">$100</span>
                            <span className="text-gray-500 font-medium">/ month</span>
                        </div>
                        <ul className="space-y-4 mb-8 text-gray-600">
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-emerald-600" />
                                Funds new school blocks and digital learning labs.
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-emerald-600" />
                                Establishes teacher salary stabilization endowments.
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="mt-1 w-1.5 h-1.5 rounded-full bg-emerald-600" />
                                Full transparency with annual board report access.
                            </li>
                        </ul>
                        <Link
                            href="/programs"
