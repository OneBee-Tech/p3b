            ...
            <form action={createRegistryChild} className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 space-y-6">
                ...
                <div className="space-y-4 pt-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea name="story" rows={4} placeholder="Write a brief background story or update to be displayed on the public sponsorship page..." className="w-full bg-cinematic-dark/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-trust-blue resize-none"></textarea>
